...
// Uniswap V3 SqrtPriceMath, used by quoteXToY. Q32.48 sqrt-price (uint80).
...
// Uniswap V3 SqrtPriceMath, used by quoteYToX. Q32.48 sqrt-price (uint80).
...
// getAmountXDelta writes |Δx| between two Q32.48 sqrt prices for a given
// liquidity into dst.
...
// getAmountYDelta writes |Δy| between two Q32.48 sqrt prices for a given
// liquidity into dst.
